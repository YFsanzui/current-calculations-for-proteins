...
class Particle(Point):
    ...
    Attributes:
        ...
        phi: Coulomb potential of the particle.
    """
    
    def __init__(self, coords=[], domain=1.0, q = 1.0):
...
def get_multipole(particles, p, cells, leaves, n_crit):
    ...
    # otherwise cell p is a leaf cell
        ...
        for i in range(cells[p].nleaf):
            ...
            cells[p].multipole += particles[l].q * \
...
def read_particle(filename):
    ...
    for line in file:
        ...
        coords, q = line[1:4], line[-1]
        particle = Particle(coords=coords, q = q)
